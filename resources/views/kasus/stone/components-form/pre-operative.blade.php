<div class="row">
    ...
    <div class="col-lg-6 col-md-12">
        @include('kasus.components-form.radio-button-multi-opsi',['default'=> $kasus->operative_pre->case_type ?? '','label'=>'Case Type','name'=>'pre_operative__case_type','options' => ['New','Residif','Rest Stone']])
    </div>
    <div class="col-lg-6 col-md-12">
        <div class="form-group">
