...
namespace App\Http\Controllers\KasusAnamnesis;

use Illuminate\Http\Request;
use App\Http\Controllers\Controller;
use App\Models\KasusAnamnesis;
use Auth;
...
class PostController extends Controller
{
    ...
    {
    	$last_data = KasusAnamnesis::where('kasus_id',$data['kasus_id'])->first();
        if(!empty($last_data)) $last_data->delete();

    	$new_data= new KasusAnamnesis;
